...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['id' => 23, 'parent_id' => 4, 'name' => 'Menu Manager', 'href' => '/imenus', 'icon' => 'fluent:food-32-regular', 'sequance' => 23, 'status' => 1],
            ['id' => 24, 'parent_id' => 4, 'name' => 'Make Options', 'href' => '/imenus/options', 'icon' => 'ion:fast-food-outline', 'sequance' => 24, 'status' => 1],
