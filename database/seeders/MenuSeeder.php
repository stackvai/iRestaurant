...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['id' => 4, 'parent_id' => null, 'name' => 'Menus', 'href' => '/menu', 'icon' => 'lucide:boxes', 'sequance' => 4, 'status' => 1],
            ...
            ['id' => 23, 'parent_id' => 4, 'name' => 'Menu Manager', 'href' => '/menu/manager', 'icon' => 'mdi:cart-arrow-right', 'sequance' => 23, 'status' => 1],
            ['id' => 24, 'parent_id' => 4, 'name' => 'Make Options', 'href' => '/menu/options', 'icon' => 'mdi:cart-arrow-right', 'sequance' => 24, 'status' => 1],
            ['id' => 25, 'parent_id' => 9, 'name' => 'Coupon Offers', 'href' => '/marketing/coupon', 'icon' => 'mdi:cart-arrow-right', 'sequance' => 25, 'status' => 1],
            ['id' => 26, 'parent_id' => 9, 'name' => 'Popup Offers', 'href' => '/marketing/popup', 'icon' => 'mdi:cart-arrow-right', 'sequance' => 26, 'status' => 1],
        ];
