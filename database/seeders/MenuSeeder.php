...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['id' => 4, 'parent_id' => null, 'name' => 'Menus', 'href' => '#', 'icon' => 'lucide:boxes', 'sequance' => 4, 'status' => 1],
            ...
            ['id' => 23, 'parent_id' => 4, 'name' => 'Menu Manager', 'href' => '/imenus', 'icon' => 'mdi:cart-arrow-right', 'sequance' => 23, 'status' => 1],
            ['id' => 24, 'parent_id' => 4, 'name' => 'Make Options', 'href' => '/imenus/options', 'icon' => 'mdi:cart-arrow-right', 'sequance' => 24, 'status' => 1],
