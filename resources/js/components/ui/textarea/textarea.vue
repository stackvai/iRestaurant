...
<template>
  <div class="w-full">
    <label for="input">{{ label }}<span v-if="isRequired" class="">*</span></label>
    <textarea v-model="modelValue" :placeholder="placeholder" data-slot="input" :required="isRequired" rows="3" :class="cn(
